...
#Add Homestuck
comicsList = [{:name => "Homestuck", :author => "Andrew Hussie", :url => "http://www.mspaintadventures.com/?s=6", :synopsis => "A young boy plays a video game with some of his friends and learns that this game will decide the fate of not only his own universe, but perhaps all of reality", :genre => "fantasy", :rating_art => 0}]
#Add Paranatural
...
#Add Problem Sleuth
comicsList << [{:name => "Problem Sleuth", :author => "Andrew Hussie", :url => "http://www.mspaintadventures.com/?s=4", :synopsis => "Three detectives try to escape their office building, which they have all managed to be trapped in. Shenanigans ensue", :genre => "Comedy"}]
#Add Stand Still, Stay Silent
comicsList << [{:name => "Stand Still, Stay Silent", :author => "Minna Sundberg", :url => "http://www.sssscomic.com/", :synopsis => "It's been 90 years after the end of the old world. But now, at last, it is time to send out an research crew into the great unknown! A poorly funded and terribly unqualified crew, but a crew nonetheless.", :genre => "post-apocalyptic"}]
#Add Gunnerkrigg Court
comicsList << [{:name => "Gunnerkrigg Court", :author => "Tom Siddell", :url => "http://www.gunnerkrigg.com/", :synopsis => "\"My name is Antimony Carver. I would like to share with you the strange events that took place while I attended school at Gunnerkrigg Court.\"", :genre => "scifi, fantasy, school"}]
